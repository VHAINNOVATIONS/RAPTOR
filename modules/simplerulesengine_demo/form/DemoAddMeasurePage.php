...
module_load_include('php','simplerulesengine_ui','form/AddMeasurePage');
module_load_include('inc','simplerulesengine_demo','core/EvalEngine');

/**
 * This class implements the Add Measure page
 *
 * @author Frank Font of SAN Business Consultants
 */
class DemoAddMeasurePage extends \simplerulesengine\AddMeasurePage
{
