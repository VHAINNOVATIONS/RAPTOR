...
function get_raptor_workflow_status($code) 
{
...
function getRankScoreIcon($score)
{
    if($score > 600)
    {
        $url = '/drupal/sites/all/themes/raptor_omega/images/score_critical.png';
    } else if($score > 450) {
        $url = '/drupal/sites/all/themes/raptor_omega/images/score_urgent.png';
    } else if($score > 200) {
        $url = '/drupal/sites/all/themes/raptor_omega/images/score_high.png';
    } else if($score > 100) {
        $url = '/drupal/sites/all/themes/raptor_omega/images/score_medium.png';
    } else if($score > 20) {
        $url = '/drupal/sites/all/themes/raptor_omega/images/score_low.png';
    } else if($score > 0) {
        $url = '/drupal/sites/all/themes/raptor_omega/images/score_verylow.png';
    } else {
        $url = '/drupal/sites/all/themes/raptor_omega/images/score_zero.png';
    }
...
<script>
    Drupal.pageData = {
        hiddenColumns : <?php echo $hiddenColsJSON ?>
    };
</script>
...
<div id="worklist_container">
    ...
    ?>
    <p>This account does not have data access privileges.</p>
            ...
            <div class="right-content">
                ...
                <div id="worklist_wrapper">
                    ...
                    <table id="worklistTable" class="datatable" width="100%" border="0" cellspacing="0" cellpadding="0" style="display: none;">
                        <thead>
                            <tr>
                                <td class="chk-all"><input title="Change all values" type="checkbox" id="chk_new" data-checkId="chk" ></td>
                                ...
                                <th class="desired_column">Date/Time Desired</th>
                        ...
                        <tbody class="table-content">
                            ...
                            <tr data-rawrtid="<?php echo('['.$data_row[0].']') ?>" style="<?php echo($rowStyle); ?>">
                                ...
                                <td class="status_column"><?php echo(get_raptor_workflow_status($data_row[11])) ?></td>
...
<div id="column-modal" style="display:none;" title="Change Columns">
    <div class="change-columns-modal">
        ...
        <form>
            ...
            <label><input type="checkbox" checked name="column_display" value="4"><span>Date/Time Desired</span></label>
            ...
            <label><input type="checkbox" checked name="column_display" value="15"><span>Scheduled</span></label>
        </form>
    </div>
</div> <!--! end of modal -->
