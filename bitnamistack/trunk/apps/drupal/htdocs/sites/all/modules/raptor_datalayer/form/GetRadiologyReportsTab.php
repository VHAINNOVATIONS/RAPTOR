...
class GetRadiologyReportsTab
{
    ...
    private static function getImageInfoAsHtml($oContext, $patientDFN, $patientICN, $reportID, $caseNumber)
    {
        try
        {
            ...
            $aImageInfo = raptor_datalayer_getAvailImageMetadata($oContext, $patientDFN, $patientICN, $reportID, $caseNumber);
    ...
    function getForm($form, &$form_state, $disabled, $myvalues)
    {
        ...
        $raptor_protocoldashboard = $oDD->getDashboardDetails($this->m_oContext);
