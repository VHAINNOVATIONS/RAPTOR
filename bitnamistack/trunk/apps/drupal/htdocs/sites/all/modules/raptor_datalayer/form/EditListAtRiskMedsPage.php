 ...
 * @author FrankWin7VM
 */
class EditListAtRiskMedsPage
{

    private $m_oPageHelper      = null;
    private $m_sTablename       = 'raptor_atrisk_meds';
    private $m_aFieldNames      = array('keyword');
    private $m_aRequiredCols    = array(true);
    private $m_aMaxLenCols      = array(40);
    private $m_aDataTypeCols    = array('t');
    private $m_aHelpText        = array('Keyword');
    private $m_aOrderBy         = array('keyword');    
