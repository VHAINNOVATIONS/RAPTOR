 ...
 * @author FrankWin7VM
 */
class EditListSedationPage
{

    private $m_oPageHelper      = null;
    private $m_sTablename       = 'raptor_list_sedation';
    ...
    private $m_aHelpText        = array('Category','Sedation Text','Applies to CT?','Applies to MR?','Applies to NM?');
