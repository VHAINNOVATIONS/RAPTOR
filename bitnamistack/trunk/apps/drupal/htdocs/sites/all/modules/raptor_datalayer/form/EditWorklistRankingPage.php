...
require_once(dirname(__FILE__) . "/../core/data_user.php");

/**
 * This page allows the user to override their values for ranking purposes.
 * 
 * URL: raptor_datalayer/editworklistranking
 *
 * @author FrankWin7VM
 */
    ...
    function getForm($form, &$form_state, $disabled, $myvalues)
    {
       ...
       $form['data_entry_area1']['action_buttons'] = array(
        ...
        $form['data_entry_area1']['action_buttons']['cancel'] = array('#type' => 'item'
                , '#markup' => '<input class="raptor-dialog-cancel" type="button" value="Cancel" data-redirect="/drupal/worklist">');
