 ...
 * @author FrankWin7VM
 */
class EditListHydrationPage
{

    private $m_oPageHelper      = null;
    private $m_sTablename       = 'raptor_list_hydration';
    ...
    private $m_aHelpText        = array('Category','Hydration Text','Applies to CT?','Applies to MR?','Applies to NM?');
