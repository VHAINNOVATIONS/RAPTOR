...
module.exports = {
	...
	getChemHemSpecimens: function(params, session, ewd) {
		...
		var ddrResults = vistaLib.ddrLister2(params, ewd); // TODO: change this to use DDR LISTER 3 implementation!!!
	...
	getLrdfnFromDfn: function(dfn, session, ewd) {
		return vistaLib.mEval("$G(^DPT(" + dfn + ",\"LR\"))", session, ewd);
	}
};
