module.exports = {
	...
	saveNewRadiologyOrder: function(params, session, ewd) {
		...
		list[(dialogDef.CONTRACT + ",1")] = params.contractSharingIen; 
		list[(dialogDef.RESEARCH + ",1")] = params.researchIen; 
		list[(dialogDef.LOCATION + ",1")] = params.locationIen; 
