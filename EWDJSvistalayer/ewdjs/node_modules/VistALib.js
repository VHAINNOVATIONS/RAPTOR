...
module.exports = {
  ...
  // testing using RPCs for authenticate - doesn't seem to be working...
	login2: function(params, session, ewd) {
		params.rpcName = "XUS SIGNON SETUP";
		params.rpcArgs = [];
		
		var setupResponse = this.runRpc(params, session, ewd);
		//return setupResponse;
		params.rpcName = "XUS AV CODE";
		params.rpcArgs = [];
		params.rpcArgs.push({ type: "LITERAL", value: this.encryptRpcParameter(params.accessCode + ";" + params.verifyCode, session, ewd) });
