...
module.exports = {
  ...
  login: function(ewd, session) {
	...
	getUserSecurityKeys: function(params, session, ewd) {
		return userLib.getUserSecurityKeys(params, session, ewd);
	},
	...
	scratch: function(params, session, ewd) {
		...
		params.dialogId = "35";
		params.locationIen = "136";
		params.providerDuz = "983";
		params.orderableItemIen = "2771";
		params.startDateTime = "Sep 11,2015@09:30";
		...
		params.preOpDateTime = "Sep 11,2015@08:30";
		...
		params.orderChecks = [{ id: "456", name: "LOCAL CHECKS", level: "1" }];
		
		return radiologyOrdersLib.saveNewRadiologyOrder(params, session, ewd);
