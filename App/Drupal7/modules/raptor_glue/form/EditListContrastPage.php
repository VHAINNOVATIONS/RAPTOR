 ...
 */
class EditListContrastPage
{

    private $m_oPageHelper      = null;
    private $m_sTablename       = 'raptor_list_contrast';
    ...
    private $m_aHelpText        = array('Category','Contrast Text','Applies to CT?','Applies to MR?','Applies to NM?');
