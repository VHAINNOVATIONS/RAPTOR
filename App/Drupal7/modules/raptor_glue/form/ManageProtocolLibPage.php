    ...
    function getForm($form, &$form_state, $disabled, $myvalues)
    {
        ...
        foreach($result as $item) 
        {
            ...
            $rows .= "\n".'<tr>'
                  ...
                  . '<td>'.$item->version.'</td>'
                  . '<td>'.$keywords.'</td>'
                  . '<td><a href="/drupal/raptor/viewprotocollib?protocol_shortname='.$item->protocol_shortname.'">View</a></td>'
                  . '<td><a href="/drupal/raptor/editprotocollib?protocol_shortname='.$item->protocol_shortname.'">Edit</a></td>'
                  . '<td><a href="/drupal/raptor/deleteprotocollib?protocol_shortname='.$item->protocol_shortname.'">Delete</a></td></tr>';
        }
       ...
       $form['data_entry_area1']['action_buttons'] = array(
        ...
        $form['data_entry_area1']['action_buttons']['create'] = array('#type' => 'item'
                , '#markup' => '<input class="raptor-dialog-submit" type="button" value="Add Protocol" data-redirect="/drupal/raptor/addprotocollib" />');
