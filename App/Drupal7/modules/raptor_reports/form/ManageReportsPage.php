...
require_once(RAPTOR_REPORTS_PATH . '/report/ViewReport1Page.php');
require_once(RAPTOR_REPORTS_PATH . '/report/ViewReport2Page.php');
require_once(RAPTOR_REPORTS_PATH . '/report/ViewReportContraindicationInputs.php');
require_once(RAPTOR_REPORTS_PATH . '/report/ViewReportContraindicationRules.php');
require_once(RAPTOR_REPORTS_PATH . '/report/ViewReportRoomReservations.php');
require_once(RAPTOR_REPORTS_PATH . '/report/ViewReportUserActivity.php');
...
class ManageReportsPage
{
    ...
    function getForm($form, &$form_state, $disabled, $myvalues)
    {
        ...
        $aReports = array(
            new ViewReport1Page()
            , new ViewReport2Page()
            , new ViewReportContraindicationInputs()
            , new ViewReportContraindicationRules()
            , new ViewReportRoomReservations()
            , new ViewReportUserActivity
        );
