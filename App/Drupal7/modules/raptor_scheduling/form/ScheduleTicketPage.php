...
class ScheduleTicketPage
{
    ...
    public function getForm($form, &$form_state, $disabled, $myvalues)
    {
        ...
        if($disabled || !is_array($myvalues['rooms']))
        {
            ...
            {
                $htmlroomoptions .= '<li><span class="location-option selectable-text"><a href="javascript:setTextboxByName(' 
                        . "'location_tx','" . $aRoom[0] . "' )" . '"'
        ...
        {
            $htmldurations .= '<li><span class="duration-option selectable-text"><a href="javascript:setTextboxByName(' 
