            ...
            <li>
              ...
              <li>
                ...
                <div id="tab-content6" class="tab-content animated fadeIn">
                  ...
                  <!-- Readonly -->
                  <section class="read-only2" data-url="raptor/getradiationdosehxtab">
                    <!-- <h3>Medications Page</h3>
                    <p>Content goes here...</p> -->
...
<iframe id="iframe_a" style="display:none;" name="iframe_a" width="100%" height="600px" ></iframe>
                  ...
                  <!-- Readonly -->
                  <section class="read-only2" data-url="<?php echo(RAPTOR_ROOT_URL) ?>raptor/getradrptstab">
              ...
              <li>
                ...
                <div id="tab-content11" class="tab-content animated fadeIn">
                  ...
                  <!-- Readonly -->
                  <section class="read-only2" data-url="raptor/getprotocollibtab">
                    <!-- <h3>Medications Page</h3>
                    <p>Content goes here...</p>
